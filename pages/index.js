...
import largeGroup from '../public/docs/2025-26/info/largeGroup.json';
import ministries from '../public/docs/2025-26/info/ministries.json';
import igs from '../public/docs/2025-26/info/igs.json';
import subcommittees from '../public/docs/2025-26/info/subcommittees.json';
import committee from '../public/docs/2025-26/info/committee.json';
...
export default function Home() {
    return (
        <div>
            <Head>
                <title>UTCCF - University of Toronto Chinese Christian Fellowship</title>
            </Head>
            <section className={styles.centered} id="header">
                ...
                <p className={styles.siteSubtitle}>University of Toronto Chinese Christian Fellowship</p>
